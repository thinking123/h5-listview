...
import {RecyclerListView, DataProvider, LayoutProvider} from './listview';
 ...
 */
export  class RecycleTestComponent extends React.Component<{},RecycleTestComponentState> {
    
    private _layoutProvider:object;
    ...
    render() {
        return <RecyclerListView useWindowScroll={true} 
