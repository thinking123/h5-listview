...
export interface RecyclerListViewProps {
    layoutProvider: BaseLayoutProvider|any;
    dataProvider: BaseDataProvider| any;
    rowRenderer: (type: string | number, data: any, index: number, extendedState?: object) => JSX.Element | JSX.Element[] | null | any;
...
export default class RecyclerListView<P extends RecyclerListViewProps, S extends RecyclerListViewState> extends ComponentCompat<P, S> {
    ...
    private _onSizeChanged = (layout: Dimension): void => {
        // this._layout.height  this._layout.width  ：{ height: window.innerHeight, width: window.innerWidth }
